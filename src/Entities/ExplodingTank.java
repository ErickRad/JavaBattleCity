...
public class ExplodingTank extends Explosion {
     ...
     */
        ...
        super(x - 8, y - 8);
        loadImage("images/big_explosion_1.png");
        getImageDimensions();
    }
    ...
    public void updateAnimation() {
        if ((System.currentTimeMillis() - initialTime) > 125) {
            loadImage("images/big_explosion_2.png");
            getImageDimensions();
        }
        if ((System.currentTimeMillis() - initialTime > 500)) {
            loadImage("images/big_explosion_3.png");
            getImageDimensions();
        }
        if ((System.currentTimeMillis() - initialTime > 700)) {
            loadImage("images/big_explosion_4.png");
            getImageDimensions();
        }
        if ((System.currentTimeMillis() - initialTime > 900)) {
            loadImage("images/big_explosion_5.png");
            getImageDimensions();
        }
